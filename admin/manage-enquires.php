...
?>
	...
	<head>
		<title>HS | Admin Gestionar las Consultas</title>
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.html">Inicio</a><i class="fa fa-angle-right"></i>Gestionar las Consultas</li>
				</ol>
										...
										foreach ($results as $result) {				?>
											<tr>
												...
												<?php } else { ?>
													...
													<td><a href="manage-enquires.php?eid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('¿Realmente quiere leer?')">Pendiente</a>
													</td>
												<?php } ?>
											</tr>
									<?php }
