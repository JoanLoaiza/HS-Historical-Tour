...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_REQUEST['bckid'])) {
		...
		$query->execute();
		$msg = "Reserva activada con éxito";
	}
...
?>
	...
	<head>
		<title>HS | Admin Gestión de Reservas</title>
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {				?>
											<tr>
												...
												?><td>Cancelled</td>
												<?php } else { ?>
													<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid); ?>" onclick="return confirm('¿Realmente quiere cancelar la reserva?')">Cancelar</a> / <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid); ?>" onclick="return confirm('¿Realmente quieres confirmar la reserva?')">Confirmar</a></td>
												<?php } ?>
