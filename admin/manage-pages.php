	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.html">Inicio</a><i class="fa fa-angle-right"></i>Actualizar los datos de la página </li>
				</ol>
				<!--grid-->
				<div class="grid-form">
					...
					<div class="grid-form1">
						<h3>Actualizar los datos de la página</h3>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
												...
												<option value="manage-pages.php?type=privacy">Políticas y privacidad</option>
									...
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Seleccion página</label>
										<div class="col-sm-8">
											<?php
