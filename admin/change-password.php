...
?>
	...
	<head>
		<title>TMS | Admin Cambio de contraseña</title>
		...
		<script type="text/javascript">
			function valid() {
				if (document.chngpwd.newpassword.value != document.chngpwd.confirmpassword.value) {
					alert("La nueva contraseña y el campo de contraseña de Confirmación no coinciden  !!");
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Inicio</a><i class="fa fa-angle-right"></i>Perfil <i class="fa fa-angle-right"></i> Cambio de contraseña</li>
				</ol>
				<!--grid-->
				<div class="grid-form">
